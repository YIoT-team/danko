...
class YIoTInputIpParams extends StatefulWidget {
  ...
  _YIoTInputIpParamsState? state;

  @override
  State<YIoTInputIpParams> createState() {
    state = new _YIoTInputIpParamsState(
...
class _YIoTInputIpParamsState extends State<YIoTInputIpParams> {
  late final showLoginPass;
  late final showAccessibility;
  late final showVpnConfig;
